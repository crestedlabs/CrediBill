...
function SidebarProvider({
  ...
  const toggleSidebar = React.useCallback(() => {
    // Evaluate mobile at click time to avoid hydration timing issues where `isMobile`
    // might be stale on first render. This ensures the toggle opens the sheet on
    // mobile immediately when the trigger is clicked.
